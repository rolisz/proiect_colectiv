...
class ProiecteDepartament(Entity):
    ...
    class Admin(EntityAdmin):
        ...
        list_display = table.Table(
            [table.ColumnGroup(('Informatii proiect'), ['nume_proiect', 'descriere', 'desfasurat', ]),
             table.ColumnGroup(('Detalii faza proiect'),
                               [ 'nume_faza', 'descriere_faza', 'data_inceput', 'data_sfarsit']),
             table.ColumnGroup(('Detalii membrii proiect'),
                               [ 'nume_membru', 'doctorat', 'functie_membru', ])]
        )
