...
class MyApplicationAdmin(ApplicationAdmin):
    ...
    def get_sections(self):
        ...
        return [ Section( _('My classes'),
                          ...
                          items = [Activitati,ActivitatiGranturi,EchipaActivitate,FazeActivitate,ProgrameStudiu,ResurseFinanciare,ResurseUmane,MembriActivitate] ),
